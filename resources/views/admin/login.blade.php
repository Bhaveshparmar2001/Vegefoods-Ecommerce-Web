    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center text-white p-t-10">
                        <h3>Admin Login</h3>
                    </div>
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="remember" id="drop-remove">
                                    <label class="custom-control-label text-white" for="drop-remove">Remember Password</label>
                                </div>
                            </div>
                        </div>
                ...
                <div id="recoverform">
                    ...
                    <div class="row m-t-20">
                        <!-- Form -->
                        <form class="col-12" action="{{ route('admin.forgot.submit')}}" method="post">
                            @csrf
                            <!-- email -->
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                ...
                                <input type="email" class="form-control form-control-lg" name="email" placeholder="Email Address" aria-label="email" aria-describedby="basic-addon1" required="">
                            </div>
                            <!-- pwd -->
