...
<head>
    ...
    <link href="{{ asset('assets/admin/extra-libs/calendar/calendar.css') }}" rel="stylesheet" />
...
<body>
    ...
    <script src="{{ asset('assets/admin/dist/js/jquery.ui.touch-punch-improved.js') }}"></script>
